...
namespace UnityEngine.XR.Interaction.Toolkit
{
    ...
    public partial class MyActionBasedController : XRBaseController
    {
        [SerializeField]
        ...
        [SerializeField]
        InputActionProperty m_PrimaryButtonTap = new InputActionProperty(new InputAction("PrimaryButtonTap", expectedControlType: "Integer"));
        public InputActionProperty primaryButtonTap
        {
            get => m_PrimaryButtonTap;
            set => SetInputActionProperty(ref m_PrimaryButtonTap, value);
        }

        [SerializeField]
        InputActionProperty m_PrimaryButtonLongPress = new InputActionProperty(new InputAction("PrimaryButtonLongPress", expectedControlType: "Integer"));
        public InputActionProperty primaryButtonLongPress
        {
            get => m_PrimaryButtonLongPress;
            set => SetInputActionProperty(ref m_PrimaryButtonLongPress, value);
        }
        ...
        void EnableAllDirectActions()
        {
            ...
            m_PrimaryButtonTap.EnableDirectAction();
            m_PrimaryButtonLongPress.EnableDirectAction();
        ...
        void DisableAllDirectActions()
        {
            ...
            m_PrimaryButtonTap.DisableDirectAction();
            m_PrimaryButtonLongPress.DisableDirectAction();
